...
@Service
public class ExportExcelDataHerramientasMunicipio {
    ...
    public ByteArrayInputStream exportAllData(Integer idMunicipio) throws Exception{
        ...
        Object[] herramientas = herramientaRepository.findTotalHerramientasMunicipio(idMunicipio).get(0);
        ...
        List<Object[]> topDocentes = personaRepository.findHerramientasByMunicipio(idMunicipio);
        ...
        List<Object[]> topInstituciones = institucionRepository.findHerramientasByMunicipio(idMunicipio);
        String [] rankingInstituciones = new String[3];
        topInstituciones.forEach(inst -> {
            rankingInstituciones[Integer.parseInt(inst[0].toString())-1] = inst[0] + " lugar. " + inst[1] + ", " + inst[2] + " herramientas realizadas";
        });
